...
*/}}
{{- define "hello-world.configMapName" -}}
{{- printf "%s-config" (include "hello-world.fullname" .) }}
{{- end }}

{{/*
Create the name of the service
*/}}
{{- define "hello-world.serviceName" -}}
{{- printf "%s" (include "hello-world.fullname" .) }}
{{- end }}

{{/*
Create the name of the route
*/}}
{{- define "hello-world.routeName" -}}
{{- printf "%s" (include "hello-world.fullname" .) }}
{{- end }}
